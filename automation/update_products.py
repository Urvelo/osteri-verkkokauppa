...
def sign_request(params, secret):
    """Generate HMAC-SHA256 signature for AliExpress IOP API (/sync endpoint).
    
    Sign string = sorted(key+value pairs) concatenated, NO secret wrapping.
    HMAC key = the app secret.
    """
